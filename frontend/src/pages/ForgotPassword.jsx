...
function ForgotPassword() {
  ...
  const handleResetPassword =async () => {
    ...
    try{
      setLoading(true);
      const result = await axios.post(`${serverUrl}/api/auth/reset-password`,{email, password}, {withCredentials: true});
        ...
        {step==3 && 
          <div>
            {/* OTP */}
              ...
              <div className="mb-4">
                <label className="block text-gray-700 font-medium mb-1" htmlFor='confirmPass'>Confirm Password : </label>
                <input
                  onChange={(e) => {
